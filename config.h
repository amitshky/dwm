...
static const char *cleanupcmd[]    = { "/usr/bin/env", "bash", "-c", "volume_level && cleanup && restart_copyq", NULL };
...
static const char *mediaprevcmd[] = { "/usr/bin/env", "bash", "-c", "playerctl previous", NULL };
